...
find_path(LAMURE_NPR_PROCESSING_INCLUDE_DIR NAMES /lamure/npr/core.h PATHS ${LAMURE_INCLUDE_SEARCH_DIRS})
...
IF (MSVC)
  ...
  find_library(LAMURE_NPR_PROCESSING_LIBRARY NAMES lamure_npr_processing.lib PATHS ${LAMURE_LIBRARY_SEARCH_DIRS} PATH_SUFFIXES release)  
  ...
  find_library(LAMURE_NPR_PROCESSING_LIBRARY_DEBUG NAMES lamure_npr_processingd.lib PATHS ${LAMURE_LIBRARY_SEARCH_DIRS} PATH_SUFFIXES debug)
...
ELSEIF (UNIX)
  ...
  find_library(LAMURE_NPR_PROCESSING_LIBRARY NAMES liblamure_npr_processing.so PATHS ${LAMURE_LIBRARY_SEARCH_DIRS})
  ...
  set(LAMURE_NPR_PROCESSING_LIBRARY_DEBUG ${LAMURE_NPR_PROCESSING_LIBRARY})
...
find_package_handle_standard_args(LAMURE DEFAULT_MSG
    LAMURE_COMMON_LIBRARY LAMURE_RENDERING_LIBRARY LAMURE_NPR_PROCESSING_LIBRARY
    LAMURE_COMMON_INCLUDE_DIR LAMURE_RENDERING_INCLUDE_DIR LAMURE_NPR_PROCESSING_INCLUDE_DIR)

if(LAMURE_FOUND)
   set(LAMURE_INCLUDE_DIRS ${LAMURE_COMMON_INCLUDE_DIR} ${LAMURE_RENDERING_INCLUDE_DIR} ${LAMURE_NPR_PROCESSING_INCLUDE_DIR})
endif()
