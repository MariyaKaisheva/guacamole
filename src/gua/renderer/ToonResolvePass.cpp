...
////////////////////////////////////////////////////////////////////////////////
ToonResolvePassDescription::ToonResolvePassDescription()
  : PipelinePassDescription()
{
  vertex_shader_ = "shaders/common/fullscreen_quad.vert";
  fragment_shader_ = "shaders/npr_resolve.frag"; 
  name_ = "ToonResolvePass";
...
////////////////////////////////////////////////////////////////////////////////
bool ToonResolvePassDescription::enable_gooch_shading() const {
  auto uniform(uniforms.find("gua_enable_gooch_shading"));
  return boost::get<bool>(uniform->second.data);
}
/*
////////////////////////////////////////////////////////////////////////////////
...
*/
////////////////////////////////////////////////////////////////////////////////
ToonResolvePassDescription& ToonResolvePassDescription::tone_mapping_exposure(float value)
{
...
////////////////////////////////////////////////////////////////////////////////
float ToonResolvePassDescription::tone_mapping_exposure() const {
  auto uniform(uniforms.find("gua_tone_mapping_exposure"));
  return boost::get<float>(uniform->second.data);
}

////////////////////////////////////////////////////////////////////////////////
ToonResolvePassDescription& ToonResolvePassDescription::tone_mapping_method(ToneMappingMethod value) {
  tone_mapping_method_ = value;
  return *this;
}

////////////////////////////////////////////////////////////////////////////////
ToonResolvePassDescription::ToneMappingMethod ToonResolvePassDescription::tone_mapping_method() const {
...
*/
////////////////////////////////////////////////////////////////////////////////
std::shared_ptr<PipelinePassDescription> ToonResolvePassDescription::make_copy() const {
  return std::make_shared<ToonResolvePassDescription>(*this);
}

////////////////////////////////////////////////////////////////////////////////
PipelinePass ToonResolvePassDescription::make_pass(RenderContext const& ctx, SubstitutionMap& substitution_map)
{
