...
ToonTriMeshRenderer::ToonTriMeshRenderer()
{
...
void ToonTriMeshRenderer::create_state_objects(RenderContext const& ctx)
{
...
void ToonTriMeshRenderer::render(Pipeline& pipe, PipelinePassDescription const& desc)
{
