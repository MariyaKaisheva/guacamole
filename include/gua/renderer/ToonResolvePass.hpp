...
#ifndef GUA_TOON_RESOLVE_PASS_HPP
#define GUA_TOON_RESOLVE_PASS_HPP
...
class GUA_DLL ToonResolvePassDescription : public PipelinePassDescription {
 public:
...
/*
  ...
  /////////////////////////////////////////////////////////////////////////////
  ToonResolvePassDescription& tone_mapping_exposure(float value);
  float tone_mapping_exposure() const;

  ToonResolvePassDescription& tone_mapping_method(ToneMappingMethod value);
...
#endif  // GUA_TOON_RESOLVE_PASS_HPP
